...
var HeaderButton = ({icon, onButtonPressed}) => {
    return (
...
export const AddNewDictionaryHeaderComponent = React.createClass ({
    render() {
        return (
            <View style={styles.headerContainer}>
                ...
                <HeaderButton
                    icon='check'
                    onButtonPressed={this.props.onSaveDictionaryButtonPressed} />
            </View>
        );
    }
});
